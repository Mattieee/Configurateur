function AfficherCacher(texte)
{
    ...
    else
    {
        ...
        $("#img-1").toggleClass("image11");
    }
}

function AfficherCacher2(texte)
{
    var test = document.getElementById(texte).style.display;
    if (test == "block")
    {
    ...
    {
        document.getElementById(texte).style.display = "block";
        $("#img-2").toggleClass("image11");
    }
}

function AfficherCacher3(texte)
{
    var test = document.getElementById(texte).style.display;
    if (test == "block")
    {
    ...
    {
        document.getElementById(texte).style.display = "block";
        $("#img-3").toggleClass("image11");
    }
}

function AfficherCacher4(texte)
{
    var test = document.getElementById(texte).style.display;
    if (test == "block")
    {
    ...
    {
        document.getElementById(texte).style.display = "block";
        $("#img-4").toggleClass("image11");
    }
}

function AfficherCacher5(texte)
{
    var test = document.getElementById(texte).style.display;
    if (test == "block")
    {
    ...
    {
        document.getElementById(texte).style.display = "block";
        $("#img-5").toggleClass("image11");
    }
}

function AfficherCacher6(texte)
{
    var test = document.getElementById(texte).style.display;
    if (test == "block")
    {
...
function f_calc(id,n)
{
    ...
    {
        initialiser_calc(id);
        var test = document.getElementById('produits').style.display;
        if (test == "block")
        {
